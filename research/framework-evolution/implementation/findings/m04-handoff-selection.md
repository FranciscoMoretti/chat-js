...
Follow-up: [direct JSX exploration](m04-direct-jsx.md) supersedes the public component-factory example. Generate local direct imports/composition and only required integration modules; do not generate a second React-component registration object. Backend tool and renderer dispatch registration are separate. Removing JSX stops rendering but does not itself uninstall source/dependencies; selected installation still owns omission.
