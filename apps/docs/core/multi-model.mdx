...
<Frame>
  <img
    src="/docs/images/ai-models.gif"
    alt="Switching between AI models in the model selector"
  />
</Frame>
...
<Callout type="note">
  Image generation uses `ai.tools.image.default`. Language models with the
  `image-generation` tag can also generate images inline. See [Image
  Generation](/features/image-generation) for details.
</Callout>
