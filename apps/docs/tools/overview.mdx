...
descriptor. Ordinary tools include a client renderer; search tools reuse the existing search presentation. Installed tools become part of your app's typed tool system.
