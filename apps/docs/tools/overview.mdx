...
descriptor. Ordinary tools include a client renderer; search and code-execution factories reuse their existing presentations. Installed tools become part of your app's typed tool system.
