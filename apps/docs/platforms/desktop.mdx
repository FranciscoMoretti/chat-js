...
<Callout type="warning">
  The current releases are **not code-signed or notarized**. Your operating
  system will show a security warning on first launch. This is expected for
  unsigned builds and does not mean the app is malicious, but you should only
  install builds from a source you trust.
</Callout>
