...
<Callout type="warning">
  The EVE-only application still has release gates for hosted provider deletion
  and guest hosting. This guide does not claim that completing the Vercel setup
  clears those gates.
</Callout>
