...
Changing backends does not migrate existing sessions. Use an isolated application database for previews and plan session migration before production cutover. Hosted conversation erasure remains unavailable.
