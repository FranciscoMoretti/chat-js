...
| `EVE_INTERNAL_ORIGIN` | **Required.** Same-origin application URL or private worker origin. |
...
| `EVE_INTERNAL_ORIGIN` | Required | Same-origin application or private worker origin |
