...
<CardGroup cols={2}>
  <Card title="create" icon="rocket" href="/reference/cli/create">
    Scaffold a new ChatJS application. Walks you through gateway, features, and auth selection.
  </Card>
  <Card title="add" icon="plus" href="/reference/cli/add">
    Add a component or feature to an existing project.
  </Card>
  <Card title="config" icon="sliders" href="/reference/cli/config">
