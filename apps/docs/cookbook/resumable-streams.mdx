...
<Callout type="note">
  ...
  The EVE-only ChatJS app resumes its native EVE event stream and does not use
  this `/api/chat` transport.
</Callout>
...
<Frame>
  <img
    src="/docs/images/resumable-streams.gif"
    alt="Stream resuming after a page reload"
  />
</Frame>
