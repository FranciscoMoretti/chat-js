...
<CardGroup cols={2}>
  <Card title="Native EVE Conversations" href="/cookbook/next-chat-transition">
    Create, resume, and recover conversations through the EVE runtime
  </Card>
...
<CardGroup cols={2}>
  <Card title="Resumable Streams Reference" href="/cookbook/resumable-streams">
    A standalone AI SDK and Redis pub/sub pattern, separate from the EVE app
  </Card>
